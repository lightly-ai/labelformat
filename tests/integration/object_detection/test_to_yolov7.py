...
def test_yolov7_to_yolov7(tmp_path: Path) -> None:
    label_input = YOLOv7ObjectDetectionInput(
...
def test_coco_to_yolov7(tmp_path: Path) -> None:
...
def test_pascalvoc_to_yolov7(tmp_path: Path) -> None:
...
def test_kitty_to_yolov7(tmp_path: Path) -> None:
...
def test_lightly_to_yolov7(tmp_path: Path) -> None:
...
def test_labelbox_to_yolov7(tmp_path: Path) -> None:
