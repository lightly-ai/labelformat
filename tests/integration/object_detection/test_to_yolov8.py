...
def test_pascalvoc_to_yolov8(tmp_path: Path) -> None:
...
def test_kitty_to_yolov8(tmp_path: Path) -> None:
...
def test_lightly_to_yolov8(tmp_path: Path) -> None:
...
def test_labelbox_to_yolov8(tmp_path: Path) -> None:
